...
public class MultiMOD {
	...
	public static DPHeap run( StemTagTrie stemDB, Spectrum spectrum, boolean dynamicPMCorrection ){
		...
		for( TagTrie stem : stemDB ){
			CandidateContainer cpool= DBSearch.construct_multimod_cpool(tPool, spectrum.getCorrectedMW(), stem);

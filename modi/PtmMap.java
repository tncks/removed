...
public class PtmMap {
	...
	public void getMODMapToPRIX( PrintWriter out ) throws IOException{		
	...
	private class PSM implements Comparable<PSM> {
		...
		public String toIdentification(ProtDatabase protDB){
			...
			int start = protDB.getRealPositionInProtein(pept.getSrcProteinInfo().get(0).getStartPos());
